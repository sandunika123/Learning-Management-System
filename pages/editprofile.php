 ...
 .card{
  ...
  <path d="M8 0a1 1 0 0 1 1 1v5.268l4.562-2.634a1 1 0 1 1 1 1.732L10 8l4.562 2.634a1 1 0 1 1-1 1.732L9 9.732V15a1 1 0 1 1-2 0V9.732l-4.562 2.634a1 1 0 1 1-1-1.732L6 8 1.438 5.366a1 1 0 0 1 1-1.732L7 6.268V1a1 1 0 0 1 1-1z"/>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9">
                    <input type="text" name="stream" id="form3Example1m" class="form-control form-control" placeholder=<?php echo $_SESSION['stream'];?> required/></p>
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" name="sub1" id="form3Example1m" class="form-control form-control" placeholder=<?php echo $_SESSION['sub1'];?> required/>
                      <input type="text" name="sub2" id="form3Example1m" class="form-control form-control" placeholder=<?php echo $_SESSION['sub2'];?> required/>
                      <input type="text" name="sub3" id="form3Example1m" class="form-control form-control" placeholder=<?php echo $_SESSION['sub3'];?> required/>
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" name="city" id="form3Example1m" class="form-control form-control"> 
                    </div>
                  </div>
                  <hr>
                  <div class="row">
    ...
    $stream=$_SESSION['stream'];
                            ...
                            if(isset($_POST['submit'])) {
                              ...
                              $sql_fname = "UPDATE Student SET FirstName='$First_name' WHERE email='$email'";
                              $sql_lname = "UPDATE Student SET LastName='$Last_name' WHERE email='$email'";
                              $sql_stream = "UPDATE Student SET stream='$stream' WHERE email='$email'";
                              $sql_sub1 = "UPDATE Student SET subject1='$sub1' WHERE email='$email'";
                              $sql_sub2 = "UPDATE Student SET subject2='$sub2' WHERE email='$email'";
                              $sql_sub3 = "UPDATE Student SET subject3='$sub3' WHERE email='$email'";
                              $sql_photo = "UPDATE Student SET photo='$filename' WHERE email='$email'";


                      mysqli_query($con,$sql_fname);
                      mysqli_query($con,$sql_lname); 
                      mysqli_query($con,$sql_stream); 
                      mysqli_query($con,$sql_sub1); 
                      mysqli_query($con,$sql_sub2); 
                      mysqli_query($con,$sql_sub3);
