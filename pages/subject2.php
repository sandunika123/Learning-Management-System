...
$msg = "";
$subject= $_SESSION['sub2'];
echo "<font color='black'><br><p style='padding-left: 40px; font-weight: bold; font-size: 35px ;' > Course Content - $_SESSION[sub2] </p></font>";
                            ...
                            $con=new mysqli($server,$username,$password, $database);  
                              ...
                              if($result->num_rows>0){
                                  ...
                                  <div class='card-body'>
                                  <font color='black'><h4 class='card-title'>$newtitle</h4></font>
