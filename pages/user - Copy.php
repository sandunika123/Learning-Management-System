        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item active" href="user.html">Lecturers</a>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row ">
                        ...
                        mysqli_query($con,$sql_insert);
                            ...
                            $email_from = 'knowledgefirstinstitute@gmail.com';

	                        $email_subject = "Welcome to LMS-KnowledgeFirst!";

	                        $email_body = "hi $email\n Your LMS-KnowledgeFirst Account has been created successfully and now you are a registered lecturer
                            of the Learning Management System of the KnowledgeFirst\n
                             Thank you for signing up with KnowledgeFirst!\n Use following credencials to login your account. 
                             \n \n
                            Password -  $password".
